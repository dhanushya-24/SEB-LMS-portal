...
// If already inside SEB, go straight to exam selection
if (isSEB()) {
    header("Location: exam_select.php");
    exit;
}

$startUrl     = "http://localhost/SEB-LMS-portal/exam_select.php";
$sebLaunchUrl = str_replace("http://", "seb://", $startUrl);
$configFile   = "seb_configs/exam_mode.seb";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
.logo-sub  { font-size: 10px; color: #2563eb; font-weight: 600; text-transform: uppercase; letter-spacing: .05em; margin-top: 2px; }
...
.btn-action:hover { background: #d1d5db; text-decoration: none; color: #1a1a1a; }
...
.security-box { background: #eff6ff; border: 1px solid #bfdbfe; border-radius: 8px; padding: 14px 18px; font-size: 13px; color: #1e40af; margin-bottom: 20px; line-height: 1.7; }
.security-box strong { color: #1e3a8a; }
</style>
</head>
<body>
...
<div class="main-wrap">
  <div class="breadcrumb">
    <a href="mode.php">Home</a><span>›</span><span>Exam Mode</span>
  </div>

  <div class="page-title">EXAM MODE — SECURE</div>

  <div class="seb-warning">
    <span style="font-size:20px;flex-shrink:0">⚠️</span>
    <div>
      <strong>Safe Exam Browser not detected.</strong><br>
      To open Exam Mode, you must launch it through Safe Exam Browser. Click <strong>"Launch Safe Exam Browser"</strong> below, or download and open the <strong>configuration file</strong>.
    </div>
  </div>

  <div class="security-box">
    🔒 <strong>Exam Security:</strong> Once inside SEB, the browser is locked to full-screen kiosk mode. Alt+Tab, Print Screen, and all external websites are disabled. You cannot exit without the <strong>exit password</strong> provided by your invigilator.
  </div>

  <div class="info-box">
    <strong>Opened:</strong> <?= date("l, d F Y, g:i A") ?><br>
    <strong>Mode:</strong> Exam — 90 minutes, entry &amp; exit password required
  </div>

  <ul class="detail-list">
    <li>Duration: <strong>90 minutes</strong> per exam</li>
    <li>To open this exam session you must launch Safe Exam Browser using the button below.</li>
    <li>This exam environment has been configured for maximum security inside Safe Exam Browser.</li>
    <li>Entry password and exit password will be provided by your invigilator.</li>
    <li>Structure: <strong>Part A</strong> — 6 MCQ (6 marks) | <strong>Part B</strong> — 2 Coding (14 marks) | <strong>Part C</strong> — 1 Long Answer (10 marks)</li>
    <li>Total: <strong>30 marks</strong></li>
  </ul>
  ...
  <div class="action-buttons">
    ...
    <a href="<?= htmlspecialchars($configFile) ?>" download="exam_mode.seb" class="btn-action">
  ...
  <div class="help-box">
    <strong>How to open Exam Mode in Safe Exam Browser:</strong><br><br>
    ...
    3. SEB will open in full-screen kiosk mode automatically<br><br>
    <strong>Method 2 — Configuration file:</strong><br>
    1. Click <em>"Download configuration"</em> to download <code>exam_mode.seb</code><br>
...
document.getElementById('btnLaunch').addEventListener('click', function() {
  setTimeout(function() {
    ...
    msg.innerHTML = '🚀 If SEB did not open:<br><small style="font-weight:400">Try downloading the <b>configuration file</b> and double-clicking it.</small>';
