...
if (!empty($_SESSION['student_id']) && !isset($_GET['switch'])) {
...
<title>SIET-LMS | Student Login</title>
...
<div class="right">
  <div class="login-card">
    ...
    <div class="hint">
      Demo: <strong>demo</strong> / <strong>demo</strong><br>
      <a href="login.php?logout=1" style="color:#15803d;font-size:11px;margin-top:6px;display:inline-block">
